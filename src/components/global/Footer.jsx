      ...
      <footer className={styles.footer + " container-fluid"}>
        <div class="row">
          <div class="col text-center">
            ...
            <p><a href="tel:0041447208000" title="Let's chat over a cup of coffee" class="text-decoration-none">+41 (0) 44 720 80 00</a></p>
            <p><a href="mailto:info@bbird.ch" title="Email us for more information" class="text-decoration-none">info@bbird.ch</a></p>
            <p>Seestrasse 185A, 8800 Thalwil, Zürich</p>
            <a href="https://linkedin.com/company/blackbird-talentsolutions" rel="nofollow" title="Connect via our LinkedIn page">
