  ...
  return (
    <section class="container py-5">
      <div class="row align-items-center">
        <div class="col-12 col-lg-5" data-aos="fade-right" data-aos-delay="300" data-aos-duration="1000">
          <Text
        ...
        <div class="col-12 col-lg-6 offset-lg-1 mb-3 mb-lg-0" data-aos="fade-left" data-aos-delay="300" data-aos-duration="1000">
