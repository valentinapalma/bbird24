    ...
    return (
        <section className="container py-5">
            ...
            <div className="row h-100 align-items-center">  
                <div className="col-12 col-lg-6 h-100 position-relative order-lg-2 mb-3 mb-lg-0" data-aos="fade-left" data-aos-delay="300" data-aos-duration="1000">
                    <CircleImage imgSrc={hrimg} altTxt={"Blackbird Recruitment - we are here for human resources."}/>
                </div>
                <div className="col-12 col-lg-6 order-lg-1" data-aos="fade-right" data-aos-delay="300" data-aos-duration="1000">
                    <Text 
                        heading={"HR"} 
